...
CREATE TABLE IF NOT EXISTS hexagon (
  ...
  pos_x FLOAT NOT NULL UNIQUE,
  pos_y FLOAT NOT NULL UNIQUE,
  pos_z FLOAT NOT NULL UNIQUE,
  is_thief BOOL NOT NULL,
  thief_pos_x FLOAT NOT NULL UNIQUE,
  thief_pos_y FLOAT NOT NULL UNIQUE,
  thief_pos_z FLOAT NOT NULL UNIQUE,
  thief_rot_z
...
CREATE TABLE IF NOT EXISTS town_conections (
  ...
  pos_y FLOAT NOT NULL UNIQUE,
  pos_z FLOAT NOT NULL UNIQUE,
  rot_x FLOAT NOT NULL UNIQUE,
  rot_y FLOAT NOT NULL UNIQUE,
  rot_z FLOAT NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS resources_card (
  ...
  hexagon_texture_path VARCHAR(200) NOT NULL,
  card_texture_path VARCHAR(200) NOT NULL,
  icon_texture_path VARCHAR(200) NOT NULL,
...
-- =========================
INSERT INTO resources_card (id, card_name, current_count, max_count, hexagon_texture_path, card_texture_path, icon_texture_path)
VALUES
    (1, 'Palo',     0, 25,  '/textures/catan/hexagon/madera_asset.png',   'TBD',  'TBD'),
    (2, 'Oveja',    0, 25,  '/textures/catan/hexagon/oveja_asset.png',    'TBD',  'TBD'),
    (3, 'Pedrolo',  0, 25,  '/textures/catan/hexagon/piedra_asset.png',   'TBD',  'TBD'),
    (4, 'Paja',     0, 25,  '/textures/catan/hexagon/trigo_asset.png',    'TBD',  'TBD'),
    (5, 'Arcilla',  0, 25,  '/textures/catan/hexagon/arcilla_asset.png',  'TBD',  'TBD'),
    (6, 'desierto', 0, 0,   '/textures/catan/hexagon/desierto_asset.png', 'TBD',  'TBD');

-- =========================
-- Insertar datos CARTAS_GAMBLEAR
-- =========================
INSERT INTO random_card (id, card_name, current_count, max_count, card_texture_path, icon_texture_path)
VALUES
    (1, 'Punto',                    0, 5,   'TBD',  'TBD'),
    (2, 'Caballero',                0, 14,  'TBD',  'TBD'),
    (3, 'Monopolio',                0, 2,   'TBD',  'TBD'),
    (4, 'Constructor de caminos',   0, 2,   'TBD',  'TBD'),
    (5, 'Recursos gratis',          0, 2,   'TBD',  'TBD'),
...
-- =========================
INSERT INTO hexagon (id, letter, pos_x, pos_y, pos_z, is_thief, thief_pos_x, thief_pos_y, thief_pos_z, thief_rot_z, resources_id)
VALUES
    (1,   'A',  -5.26,  0.404,  3.032 , false,  -5.627, 0.436,  3.57,   0.584,  6),
    (2,   'B',  -5.268, 0.404,  -0.017, false,  -5.01,  0.436,  0.752,  0.584,  6),
    (3,   'C',  -5.249, 0.404,  -3.046, false,  -5.251, 0.436,  -3.825, 1.853,  6),
    (4,   'D',  -2.636, 0.404,  -4.586, false,  -2.569, 0.436,  -3.827, 0.584,  6),
    (5,   'E',  -0.005, 0.404,  -6.09 , false,  -0.834, 0.436,  -5.576, 1.955,  6),
    (6,   'F',  2.624,  0.404,  -4.575, false,  2.404,  0.436,  -5.342, 2.599,  6),
    (7,   'G',  5.286,  0.404,  -3.069, false,  5.965,  0.436,  -3.817, -0.243, 6),
    (8,   'H',  5.278,  0.404,  -0.023, false,  5.884,  0.436,  0.547,  2.909,  6),
    (9,   'I',  5.29,   0.404,  3.025 , false,  6.001,  0.436,  3.511,  -2.58,  6),
    (10,  'J',  2.648,  0.404,  4.543 , false,  3.421,  0.436,  4.997,  3.031,  6),
    (11,  'K',  0.017,  0.404,  6.056 , false,  -0.023, 0.436,  7.096,  2.982,  6),
    (12,  'L',  -2.631, 0.404,  4.547 , false,  -2.172, 0.436,  5.229,  1.444,  6),
    (13,  'M',  -2.63,  0.404,  1.503 , false,  -3.016, 0.436,  0.817,  2.228,  6),
    (14,  'N',  -2.623, 0.404,  -1.534, false,  -3.14,  0.436,  -1.083, 2.18,   6),
    (15,  'O',  -0.004, 0.404,  -3.055, false,  1.039,  0.436,  -3.096, 0.584,  6),
    (16,  'P',  2.628,  0.404,  -1.539, false,  2.365,  0.436,  -0.99,  1.34,   6),
    (17,  'Q',  2.642,  0.404,  1.499 , false,  2.236,  0.436,  0.821,  0.584,  6),
    (18,  'R',  0.003,  0.404,  3.019 , false,  -0.679, 0.436,  3.425,  1.669,  6),
    (19,  NULL, 0.001,  0.404,  -0.021, true,   -0.524, 0.436,  -0.666, -0.243, 6);
    
-- =========================
-- Insertar datos TOWN
-- =========================
INSERT INTO town (id, player_id, level, pos_x, pos_y, pos_z)
VALUES
    (1, NULL, 0,  -6.175, 0.626, 4.518),
    (2, NULL, 0,  -6.89,  0.626, 3.044),
    (3, NULL, 0,  -6.179, 0.626, 1.543),
    (4, NULL, 0,  -6.903, 0.626, -0.103),
    (5, NULL, 0,  -6.159, 0.626, -1.467),
    (6, NULL, 0,  -6.894, 0.626, -2.961),
    (7, NULL, 0,  -6.037, 0.626, -4.419),
    (8, NULL, 0,  -4.39,  0.626, -4.52),
    (9, NULL, 0,  -3.479, 0.626, -6.074),
    (10, NULL, 0, -1.777, 0.626, -6.058),
    (11, NULL, 0, -0.741, 0.626, -7.519),    
    (12, NULL, 0, 0.833,  0.626, -7.514),
    (13, NULL, 0, 1.796,  0.626, -6.12),
    (14, NULL, 0, 3.462,  0.626, -5.913),
    (15, NULL, 0, 4.349,  0.626, -4.628),
    (16, NULL, 0, 6.094,  0.626, -4.401),    
    (17, NULL, 0, 6.855,  0.626, -3.045),
    (18, NULL, 0, 6.125,  0.626, -1.465),
    (19, NULL, 0, 7.037,  0.626, 0.089),
    (20, NULL, 0, 6.163,  0.626, 1.559),
    (21, NULL, 0, 6.906,  0.626, 3.105),
    (22, NULL, 0, 5.988,  0.626, 4.41),
    (23, NULL, 0, 4.297,  0.626, 4.556),
    (24, NULL, 0, 3.422,  0.626, 6.026),
    (25, NULL, 0, 1.709,  0.626, 6.178),
    (26, NULL, 0, 0.747,  0.626, 7.389),
    (27, NULL, 0, -0.819, 0.626, 7.405),
    (28, NULL, 0, -1.82,  0.626, 6.206),
    (29, NULL, 0, -3.502, 0.626, 6.077),
    (30, NULL, 0, -4.452, 0.626, 4.642),
    (31, NULL, 0, -3.478, 0.626, 3.002),
    (32, NULL, 0, -4.452, 0.626, 1.66),    
    (33, NULL, 0, -3.542, 0.626, 0.031),
    (34, NULL, 0, -4.356, 0.626, -1.489),
    (35, NULL, 0, -3.472, 0.626, -3.007),
    (36, NULL, 0, -1.785, 0.626, -3.02),
    (37, NULL, 0, -0.839, 0.626, -4.578),    
    (38, NULL, 0, 0.886,  0.626, -4.54),
    (39, NULL, 0, 1.79,   0.626, -3.01),
    (40, NULL, 0, 3.506,  0.626, -3.04),
    (41, NULL, 0, 4.436,  0.626, -1.515),
    (42, NULL, 0, 3.626,  0.626, 0.098),
    (43, NULL, 0, 4.348,  0.626, 1.5),    
    (44, NULL, 0, 3.509,  0.626, 3.004),
    (45, NULL, 0, 1.792,  0.626, 3.018),
    (46, NULL, 0, 0.852,  0.626, 4.599),
    (47, NULL, 0, -0.864, 0.626, 4.547),
    (48, NULL, 0, -1.805, 0.626, 3.146),
    (49, NULL, 0, -0.812, 0.626, 1.507),    
    (50, NULL, 0, -1.785, 0.626, 0.03),
    (51, NULL, 0, -0.836, 0.626, -1.585),
    (52, NULL, 0, 0.903,  0.626, -1.471),
    (53, NULL, 0, 1.763,  0.626, -0.027),
    (54, NULL, 0, 0.838,  0.626, 1.609);
