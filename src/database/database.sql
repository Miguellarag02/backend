...
CREATE TABLE IF NOT EXISTS resources_card (
  ...
  max_hex_count INT NOT NULL DEFAULT 0,
...
-- =========================
INSERT INTO resources_card (id, card_name, current_count, max_count, max_hex_count)
VALUES
    (1, 'Palo',     0, 19, 4),
    (2, 'Oveja',    0, 19, 4),
    (3, 'Piedra',   0, 19, 3),
...
VALUES
    (1,   'a',     5,  -5.26,  0.404,  3.032 , false,  -5.627, 0.436,  3.57,   0.584,  -5.208, 0.515,  2.973,  6),
    (2,   'b',     2,  -5.268, 0.404,  -0.017, false,  -5.01,  0.436,  0.752,  0.584,  -5.367, 0.515,  0.058,  6),
    (3,   'c',     6,  -5.249, 0.404,  -3.046, false,  -5.251, 0.436,  -3.825, 1.853,  -5.288, 0.515,  -2.919, 6),
    (4,   'd',     3,  -2.636, 0.404,  -4.586, false,  -2.569, 0.436,  -3.827, 0.584,  -2.534, 0.515,  -4.549, 6),
    (5,   'e',     8,  -0.005, 0.404,  -6.09 , false,  -0.834, 0.436,  -5.576, 1.955,  0.079,  0.515,  -5.983, 6),
    (6,   'f',    10,  2.624,  0.404,  -4.575, false,  2.404,  0.436,  -5.342, 2.599,  2.715,  0.515,  -4.418, 6),
    (7,   'g',     9,  5.286,  0.404,  -3.069, false,  5.965,  0.436,  -3.817, -0.243, 5.278,  0.515,  -3.004, 6),
    (8,   'h',    12,  5.278,  0.404,  -0.023, false,  5.884,  0.436,  0.547,  2.909,  5.307,  0.515,  0.138,  6),
    (9,   'i',    11,  5.29,   0.404,  3.025 , false,  6.001,  0.436,  3.511,  -2.58,  5.33,   0.515,  3.197,  6),
    (10,  'j',     4,  2.648,  0.404,  4.543 , false,  3.421,  0.436,  4.997,  3.031,  2.646,  0.515,  4.802,  6),
    (11,  'k',     8,  0.017,  0.404,  6.056 , false,  -0.023, 0.436,  7.096,  2.982,  0.064,  0.515,  6.322,  6),
    (12,  'l',    10,  -2.631, 0.404,  4.547 , false,  -2.172, 0.436,  5.229,  1.444,  -2.598, 0.515,  4.788,  6),
    (13,  'm',     9,  -2.63,  0.404,  1.503 , false,  -3.016, 0.436,  0.817,  2.228,  -2.6,   0.515,  1.715,  6),
    (14,  'n',     4,  -2.623, 0.404,  -1.534, false,  -3.14,  0.436,  -1.083, 2.18,   -2.567, 0.515,  -1.576, 6),
    (15,  'o',     5,  -0.004, 0.404,  -3.055, false,  1.039,  0.436,  -3.096, 0.584,  0.011,  0.515,  -3.085, 6),
    (16,  'p',     6,  2.628,  0.404,  -1.539, false,  2.365,  0.436,  -0.99,  1.34,   2.662,  0.515,  -1.582, 6),
    (17,  'q',     3,  2.642,  0.404,  1.499 , false,  2.236,  0.436,  0.821,  0.584,  2.792,  0.515,  1.653,  6),
    (18,  'r',    11,  0.003,  0.404,  3.019 , false,  -0.679, 0.436,  3.425,  1.669,  -0.092, 0.515,  3.173,  6),
    (19,  's',  NULL,  0.001,  0.404,  -0.021, true,   -0.524, 0.436,  -0.666, -0.243, 0.066,  0.515,  0.165,  6)
    ON DUPLICATE KEY UPDATE
    letter = VALUES(letter),
    dice_number = VALUES(dice_number),
    pos_x = VALUES(pos_x),
    pos_y = VALUES(pos_y),
    pos_z = VALUES(pos_z),
    is_thief = VALUES(is_thief),
    thief_pos_x = VALUES(thief_pos_x),
    thief_pos_y = VALUES(thief_pos_y),
    thief_pos_z = VALUES(thief_pos_z),
    thief_rot_z = VALUES(thief_rot_z),
    letter_pos_x = VALUES(letter_pos_x),
    letter_pos_y = VALUES(letter_pos_y),
    letter_pos_z = VALUES(letter_pos_z),
...
VALUES
    ...
    ON DUPLICATE KEY UPDATE
      ...
      pos_y = VALUES(pos_y),
      pos_z = VALUES(pos_z),
      resource_trade_id = VALUES(resource_trade_id),
      resource_trade_qty = VALUES(resource_trade_qty);
